...
statestoanalyze=['IN';'MI';'MN';'MO';'ND'; 'IL'; 'SD'; 'WI'; 'IA'];

%% SET MASTER DIRECTORY
if strcmp(pc,'work')
    masterdir='C:\Users\mtcraig\Desktop\EPP Research\Databases\NRELSolarPVData';
elseif strcmp(pc,'personal')
    masterdir='C:\Users\mcraig10\Desktop\EPP Research\Databases\NRELSolarPVData';
end
...
cell2csv(fullfile(masterdir,'SolarCapacityFactorsNRELMISO.csv'),filenamesandcfs);
