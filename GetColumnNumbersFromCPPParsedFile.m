...
fleetco2emsrateforedcol=find(strcmp(parsedfiledata(1,:),'CO2EmsRateForED'));
fleetnoxemsrateforedcol=find(strcmp(parsedfiledata(1,:),'NOxEmsRateForED'));
fleetso2emsrateforedcol=find(strcmp(parsedfiledata(1,:),'SO2EmsRateForED'));
fleethrforedcol=find(strcmp(parsedfiledata(1,:),'HRForED'));
fleetvomforedcol=find(strcmp(parsedfiledata(1,:),'VOMForED'));
