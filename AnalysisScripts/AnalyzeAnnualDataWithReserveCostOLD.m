...
barwidthtoplot=.75;
%ALL BLACK BARS
figure; bar(totalopandcapcostsdiffmidnobasescaled,barwidthtoplot); colormap gray; hold on
...
% for i=1:size(verticalxlabels,1)
%     text(i,-2.4,verticalxlabels(i,:),'Fontsize',12,'fontweight','bold','horizontalalignment','center');
% end
if testlowerlimit==1
    offset=-13;
else
...
for i=1:3
    ...
    for capctr=1:3 %get cost-eff in $/ton
        ...
        %Breakeven: $/ton * ton - $
        annualizedbreakevenwind=currwindcosteff*currflexemissions-currflexopcost;
        annualizedbreakevennormccs=currnormccscosteff*currflexemissions-currflexopcost;
    ...
    annualizedbreakevendispatch=currredispatchcosteff*currflexemissions-currflexopcost;
