...
statestoanalyze=['AL';'AR';'GA';'IL';'KY';'LA';'MO';'MS';'NC';'SC';'TN';'VA'];

%% SET MASTER DIRECTORY
if strcmp(pc,'work')
    masterdir='C:\Users\mtcraig\Desktop\EPP Research\Databases\NRELSolarPVData\SERC';
elseif strcmp(pc,'personal')
    masterdir='C:\Users\mcraig10\Desktop\EPP Research\Databases\NRELSolarPVData\SERC';
end
