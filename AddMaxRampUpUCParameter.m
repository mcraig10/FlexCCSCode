...
function [futurepowerplantfleet] = AddMaxRampUpUCParameter...
...
fleetcol=find(strcmp(futurepowerplantfleet(1,:),'Max Ramp Up'));
...
%Get value of max ramp up by multiplying percentage by capacity value and
